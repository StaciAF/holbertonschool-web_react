...
describe('CourseListRow />', () => {
    it('Successfully renders <CourseListRow /> component', () => {
        const wrapper = shallow(<CourseListRow textFirstCell="First cell text" />);
        expect(wrapper).toHaveLength(1);
    });
    it('Successfully renders <CourseListRow /> component with props set true & textSecondCell not passed', () => {
    ...
    it('Successfully renders <CourseListRow /> component with props set false & textSecondCell passed', () => {
    ...
    it('SUccessfully renders <CourseListRow /> component with props set to default === false', () => {
        const wrapper = shallow(<CourseListRow textFirstCell="First cell text" />);
